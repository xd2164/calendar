// EdTech Events Calendar V10 - Clean Implementation
class Calendar {
    constructor() {
        ...
        footer.innerHTML = `
            <div class="collaboration-section">
                ...
                <div class="interested-section" style="padding: 1rem; background: #fef3c7; border-radius: 0.5rem; border: 1px solid #f59e0b; margin-bottom: 1rem;">
                    ...
                    ${this.currentUser ? `
                        <button onclick="window.calendar.toggleInterest(${eventId})" class="interest-btn" style="background: #f59e0b; color: white; border: none; padding: 0.5rem 1rem; border-radius: 0.375rem; cursor: pointer; margin-top: 0.5rem;">
                            ${interestedUsers.find(u => u.id === this.currentUser.id) ? 'Cancel' : 'Register'}
                        </button>
                    ` : `
                        <div style="margin-top: 0.5rem;">
                            <button onclick="window.calendar.registerUser(${eventId})" style="background: #f59e0b; color: white; border: none; padding: 0.5rem 1rem; border-radius: 0.375rem; cursor: pointer;">
                                Register
                            </button>
                        </div>
                    `}
                ...
                <div class="attending-section" style="padding: 1rem; background: #f0fdf4; border-radius: 0.5rem; border: 1px solid #10b981; margin-bottom: 1rem;">
                    ...
                    ${this.currentUser ? `
                        <button onclick="window.calendar.toggleAttendance(${eventId})" class="attendance-btn" style="background: #10b981; color: white; border: none; padding: 0.5rem 1rem; border-radius: 0.375rem; cursor: pointer; margin-top: 0.5rem;">
                            ${attendingUsers.find(u => u.id === this.currentUser.id) ? 'Leave' : 'Joined'}
                        </button>
                    ` : `
                        <div style="margin-top: 0.5rem;">
                            <button onclick="window.calendar.registerUser(${eventId})" style="background: #10b981; color: white; border: none; padding: 0.5rem 1rem; border-radius: 0.375rem; cursor: pointer;">
                                Register
                            </button>
                        </div>
                    `}
                ...
                <div class="notes-section" style="padding: 1rem; background: #f8fafc; border-radius: 0.5rem; border: 1px solid #e2e8f0; margin-bottom: 1rem;">
                    ...
                    ${this.currentUser ? `
                        <div class="add-note-section" style="margin-bottom: 1rem;">
                            ...
                            <button onclick="window.calendar.addNote(${eventId})" style="background: #4f46e5; color: white; border: none; padding: 0.5rem 1rem; border-radius: 0.375rem; cursor: pointer; margin-top: 0.5rem;">
                                Add Note
                            </button>
                        </div>
                    ` : `
...
document.addEventListener('DOMContentLoaded', () => {
    window.calendar = new Calendar();
        console.log('EdTech Events Calendar V10 initialized');
});